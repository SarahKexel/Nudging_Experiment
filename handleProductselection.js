...
const items = [
  {
    ...
    productDescriptionBio: '<h6><b>Produktbeschreibung:</b></h6><p>Strauch-, Rispen- oder Buschtomaten sind Tomaten, die mit Kelch und Stielen geerntet werden. Tomaten waschen und den Stängelansatz sowie grüne Stellen gründlich entfernen, diese enthalten Solanin, einen Stoff der gesundheitsschädlich ist und u.a. Kopfschmerzen verursachen kann. Tomaten sind druck- und transportempfindlich. Tomaten nicht im Kühlschrank aufbewahren, da sie dann an Aroma verlieren, glasig und vorzeitig weich werden.</p><h6><b>Eigenschaften:</b></h6><p>Bio<br>Umweltverträgliche und ressourcenschonend Produktion.</br></p><h6><b>Ursprungsland:</b></h6><p>Spanien oder Deutschland; Kl.: II; Ursprungsland und Klasse können je nach Angebot abweichen.</p>',
    productDescription: '<h6><b>Produktbeschreibung:</b></h6><p>Strauch-, Rispen- oder Buschtomaten sind Tomaten, die mit Kelch und Stielen geerntet werden. Tomaten waschen und den Stängelansatz sowie grüne Stellen gründlich entfernen, diese enthalten Solanin, einen Stoff der gesundheitsschädlich ist und u.a. Kopfschmerzen verursachen kann. Tomaten sind druck- und transportempfindlich. Tomaten nicht im Kühlschrank aufbewahren, da sie dann an Aroma verlieren, glasig und vorzeitig weich werden.</p><h6><b>Ursprungsland:</b></h6><p>Marokko oder Spanien; Kl.: I; Ursprungsland und Handelsklasse können je nach Angebot abweichen. </p>',
  ...
  },
  {
    ...
    productDescriptionBio: '<h6><b>Produktbeschreibung:</b></h6><p>Bananen werden grün geerntet, denn sie reifen nach. Sie werden auf besonderen Bananenschiffen in die Verbraucherländer transportiert. Vorwiegend angebaut in Ecuador, Panama, Costa Rica, Kolumbien und Dominikanische Republik. Die Krümmung der Banane entsteht während des Wachstums hormonbedingt. Fleischig, aromatisch und je nach Reifegrad von leicht säuerlich bis sehr süß. Bananen vor Zugluft schützen! Bei zu kühlen Temperaturen färbt sich die Schale gelblich-grau bis schwarz und es kommt zu Aromaverlusten. </p><h6><b>Eigenschaften:</b></h6><p>Bio<br>Umweltverträgliche und ressourcenschonend Produktion.</br></p><h6><b>Ursprungsland:</b></h6><p>Dominikanische Republik, Ecuador oder Peru; Kl.: M; Ursprungsland und Klasse können je nach Angebot abweichen.</p>',
    productDescription: '<h6><b>Produktbeschreibung:</b></h6><p>Bananen werden grün geerntet, denn sie reifen nach. Sie werden auf besonderen Bananenschiffen in die Verbraucherländer transportiert. Vorwiegend angebaut in Ecuador, Panama, Costa Rica, Kolumbien und Dominikanische Republik. Die Krümmung der Banane entsteht während des Wachstums hormonbedingt. Fleischig, aromatisch und je nach Reifegrad von leicht säuerlich bis sehr süß. Bananen vor Zugluft schützen! Bei zu kühlen Temperaturen färbt sich die Schale gelblich-grau bis schwarz und es kommt zu Aromaverlusten.</p><h6><b>Ursprungsland:</b></h6><p>Kl.: M; Ursprungsland und Klasse können je nach Angebot abweichen.</p>',
    nudge: Math.random() >= 0.5,
    bioFirst: Math.random() >= 0.5,
  },
  {
  ...
  },
  {
    ...
    productDescriptionBio: '<h6><b>Produktbeschreibung:</b></h6><p>Bei diesen Produkten bieten wir Ihnen beste Frische und Qualität. Daher hat frische Milch nur eine kurze Haltbarkeitsdauer.<br>Frische fettarme Bio Milch, 1,5 % Fett, pasteurisiert, homogenisiert, länger haltbar.</br><p/><h6><b>Eigenschaften:</b></h6><p>Bio<br>Umweltverträgliche und ressourcenschonend Produktion.</br></p><h6><b>Ursprungsland:</b></h6><p>Deutschland</p>',
